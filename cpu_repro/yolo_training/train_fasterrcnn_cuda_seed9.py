"""Seed 9 runner for Faster R-CNN on Kaggle CUDA. Same image split as the
MPS run train_fasterrcnn_seed9.py (image_split_seed9.csv), so the two
...
directories (fasterrcnn_cuda_seed9split, eval_results/fasterrcnn_cuda/seed9)
