"""Seed 7 runner for Faster R-CNN on Kaggle CUDA. Same image split as the
MPS run train_fasterrcnn_seed7.py (image_split_seed7.csv), so the two
...
directories (fasterrcnn_cuda_seed7split, eval_results/fasterrcnn_cuda/seed7)
