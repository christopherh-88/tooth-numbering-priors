"""Seed 6 runner for Faster R-CNN on Kaggle CUDA. Same image split as the
MPS run train_fasterrcnn_seed6.py (image_split_seed6.csv), so the two
...
directories (fasterrcnn_cuda_seed6split, eval_results/fasterrcnn_cuda/seed6)
