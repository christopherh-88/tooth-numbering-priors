"""Seed 11 runner for Faster R-CNN on Kaggle CUDA. Split: image_split_seed11.csv.
Thin override wrapper, same pattern as train_fasterrcnn_seed4.py, using the
default TRAIN_DEVICE="cuda" and writing to fasterrcnn_cuda_seed11split and
eval_results/fasterrcnn_cuda/seed11.
"""
