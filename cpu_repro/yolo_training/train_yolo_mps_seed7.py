"""Seed 7 runner for YOLOv8x on local Apple Silicon (MPS). Same image split
as the Kaggle CUDA runner train_yolo_seed7.py (image_split_seed7.csv), so the
...
runs/yolov8_mps_seed7split/weights/last.pt.

Usage (local): python train_yolo_mps_seed7.py
"""
