"""Seed 5 runner for Faster R-CNN on Kaggle CUDA. Same image split as the
MPS run train_fasterrcnn_seed5.py (image_split_seed5.csv), so the two
...
directories (fasterrcnn_cuda_seed5split, eval_results/fasterrcnn_cuda/seed5)
