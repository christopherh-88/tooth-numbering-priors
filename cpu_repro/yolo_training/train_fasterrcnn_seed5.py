"""Seed 5 runner for Faster R-CNN training - extends the 5-seed
...
if it were seed 5 of the original set.
...
runs/fasterrcnn_seed5split/last.pt if it exists, so nothing is lost
beyond whatever epoch was in progress at kill time.

Usage (local, MPS): python train_fasterrcnn_seed5.py
"""
